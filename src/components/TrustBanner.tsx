...
export default function TrustBanner() {
    const trustSignals = [
        { icon: ShieldCheck, text: '5-Star Rated Service' },
        { icon: BadgeCheck, text: 'Expert Pool Technicians' },
        { icon: ThumbsUp, text: 'Sydney Eastern Suburbs' },
        { icon: CheckCircle2, text: 'Reliable & Professional' },
    ];
