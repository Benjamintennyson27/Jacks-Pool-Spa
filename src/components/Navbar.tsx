...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      ...
      >
        <a href="#" className="flex items-center -ml-2" aria-label="Jack's Pool and Spa Maintenance — Home">
          <img
            ...
            className="h-14 md:h-16 w-auto object-contain rounded-md transition-all duration-300 transform origin-left hover:scale-105"
          />
        </a>
        ...
        <div className="flex items-center gap-4">
          <a href="tel:0428226866" className="hidden md:flex items-center gap-2 text-sm font-bold hover:text-aqua transition-colors" aria-label="Call us directly at 0428 226 866">
