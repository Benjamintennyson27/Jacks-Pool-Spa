...
const ShufflerCard = () => {
  const [cards, setCards] = useState([
    { id: 1, title: 'Pool Cleaning', desc: 'Removing debris, scrubbing walls, improving longevity of your pool structure.' },
    { id: 2, title: 'Water Chemistry', desc: 'Testing water for safety and health, ensuring adequate disinfection.' },
    { id: 3, title: 'Filter Maintenance', desc: 'Backwashing, rinsing, and cleaning weekly to reduce operating costs.' },
  ]);
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 md:mb-24 text-center max-w-2xl mx-auto">
          ...
          <p className="text-lg text-charcoal/70">
            Professional pool maintenance services tailored for your residential, commercial, or Airbnb property.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="feature-card flex flex-col gap-6">
            <h3 className="text-2xl font-bold text-navy">Service Options</h3>
            <p className="text-charcoal/70">Comprehensive care ranging from pool cleaning to full filter maintenance.</p>
            <ShufflerCard />
          </div>
          ...
          <div className="feature-card flex flex-col gap-6">
            ...
            <p className="text-charcoal/70">Seamless scheduling for regular service or emergency callouts.</p>
            <SchedulerCard />
          </div>
        </div>
      </div>
